...
class RosApp():
    ...
    def mask_callback(self, data):
        try:
            self.output_image = self.bridge.imgmsg_to_cv2(data, "passthrough")
        except CvBridgeError as e:
            rospy.logerr(e)
    ...
    def main(self):
        ...
        while not rospy.is_shutdown():
            if self.cv_image is not None and self.cv_depth is not None and self.output_image is not None:
                ...
                # self.output_image_human = self.output_image_human*255
